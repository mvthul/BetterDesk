...
![Version](https://img.shields.io/badge/version-3.5.13-brightgreen.svg)
...
For custom-branded, preconfigured source builds, see the
**[RustDesk Client Generator setup](docs/features/REAL_CLIENT_GENERATOR.md#setup-from-a-clean-installation)**.
It explains the private build repository, GitHub provider, signing keys,
runners, verified target matrix and first end-to-end build.
